...
export async function POST(request: NextRequest) {
  try {
    ...
    const backendUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/authorization/google/web?${params.toString()}`;
    ...
    console.error("구글 콜백 API 최상위 오류:", error);
